...
inline static int CARDRand(void)
{
    next = next * 1103515245 + 12345;
    return (int)((unsigned int)(next / 65536) % 32768);
}

inline static void CARDSrand(unsigned int seed)
{
    next = seed;
}

inline static u32 GetInitVal(void)
{
    u32 tmp;
    u32 tick;
...
inline static u32 exnor_1st(u32 data, u32 rshift)
{
    u32 wk;
    u32 w;
    u32 i;
...
inline static u32 exnor(u32 data, u32 lshift)
{
    u32 wk;
    u32 w;
    u32 i;
